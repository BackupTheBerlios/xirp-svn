 ...
 */
public class XSash extends Sash {
	...
	/**
	 * Constructs a new sash. This constructor should be used in
	 ...
	 *            The style.
	 */
	public XSash(Composite parent, int style) {
		super(parent, style);
	 ...
	 */
	public XSash(Composite parent, int style, II18nHandler handler) {
		super(parent, style);
	...
	private void initListeners() {
		setBackground(ColorManager.getColor(Variables.SASH_COLOR));
