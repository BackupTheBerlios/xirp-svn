 ...
 */
public class XTrayItem extends TrayItem {
	...
	/**
	 * Constructs a new tray item. This constructor should be used in
	 ...
	 *            The style.
	 */
	public XTrayItem(Tray parent, int style) {
		super(parent, style);
	 ...
	 */
	public XTrayItem(Tray parent, int style, II18nHandler handler) {
		super(parent, style);
	 ...
	 * class.
	 * 
	 * @see org.eclipse.swt.widgets.TrayItem#checkSubclass()
	 */
	@Override
