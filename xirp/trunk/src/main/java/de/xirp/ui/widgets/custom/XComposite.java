...
public class XComposite extends Composite {
	...
	/**
	 * Constructs a new composite. This constructor should be used in
	 ...
	 */
	public XComposite(Composite parent, int style, II18nHandler handler) {
		super(parent, style);
	...
	/**
	 * Initializes the control and adds the appearance listeners.
	 */
