 ...
 * Changes
 * -------
 * 09.03.2007:		Created by Matthias Gernand.
 */
...
public class XScale extends Scale {
	...
	/**
	 * Constructs a new scale. This constructor should be used in
	 ...
	 *            The style.
	 */
	public XScale(Composite parent, int style) {
		super(parent, style);
	 ...
	 */
	public XScale(Composite parent, int style, II18nHandler handler) {
		super(parent, style);
