...
public class XToolBar extends ToolBar {
	...
	/**
	 * Constructs a new tool bar. This constructor should be used in
	 ...
	 *            The style.
	 */
	public XToolBar(Composite parent, int style) {
		super(parent, style);
	 ...
	 */
	public XToolBar(Composite parent, int style, II18nHandler handler) {
		super(parent, style);
	...
	/**
	 * Removes the appearance listener.
	 */
	public void removeAppearanceListener() {
		ApplicationManager.removeAppearanceChangedListener(appearanceListener);
	}
