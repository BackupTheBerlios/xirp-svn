 ...
 */
public class XCoolBar extends CoolBar {
	...
	/**
	 * Constructs a new cool bar. This constructor should be used in
	 ...
	 *            The style.
	 */
	public XCoolBar(Composite parent, int style) {
		super(parent, style);
	 ...
	 */
	public XCoolBar(Composite parent, int style, II18nHandler handler) {
		super(parent, style);
