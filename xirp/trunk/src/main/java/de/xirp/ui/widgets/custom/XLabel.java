...
public class XLabel extends Label {
	...
	// private final HWidgetAppearanceHandler handler;

	/**
	 * Constructs a new label. This constructor should be used in
	 ...
	 */
	public XLabel(Composite parent, int style, II18nHandler handler) {
		super(parent, style);
	 ...
	 *            appearance change listeners should be installed.
	 */
	public XLabel(Composite parent, int style, boolean appearance) {
		super(parent, style);
		localeHandler = new XWidgetLocaleHandler(this);
	}
