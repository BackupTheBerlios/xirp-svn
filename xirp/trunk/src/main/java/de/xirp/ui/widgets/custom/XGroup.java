...
public class XGroup extends Group {
	...
	/**
	 * Constructs a new group. This constructor should be used in
	 ...
	 *            The style.
	 */
	public XGroup(Composite parent, int style) {
		super(parent, style);
	 ...
	 */
	public XGroup(Composite parent, int style, II18nHandler handler) {
		super(parent, style);
