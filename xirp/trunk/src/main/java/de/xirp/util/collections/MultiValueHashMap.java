...
public class MultiValueHashMap<K, V> {
	...
	/**
	 * Construct a new empty MultiValueHashMap with the given initial
	 * capacity.
	 * 
	...
	/**
	 * Construct a MultiValueHashMap filling it with the given map.
	 * 
	 * @param map
	 ...
	 */
	public MultiValueHashMap(Map<? extends K, ? extends List<V>> map) {
		this.map = new ConcurrentHashMap<K, List<V>>(map);
	}
	...
	public boolean remove(V value) {
		for (List<V> keyValues : map.values( )) {
