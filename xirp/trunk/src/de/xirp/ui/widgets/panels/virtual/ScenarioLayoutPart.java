...
public class ScenarioLayoutPart extends AbstractLayoutPart {

	/**
	 * @param id
	 * @param dm
	 */
	public ScenarioLayoutPart(String id, DockingManager dm) {
		super(id, dm, null);
	}
	...
	public Composite createContent(Composite parent) {
		return new ScenarioComposite(parent, SWT.NONE);
	}
	...
	public String getNameKey() {
		return "ScenarioLayoutPart.gui.name"; //$NON-NLS-1$
	}
	...
	public Class<? extends Composite> getContentClass() {
		return ScenarioComposite.class;
	}
