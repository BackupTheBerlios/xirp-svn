...
public class MazeLayoutPart extends AbstractLayoutPart {

	/**
	 * @param id
	 * @param dm
	 */
	public MazeLayoutPart(String id, DockingManager dm) {
		super(id, dm, null);
	}
	...
	public Composite createContent(Composite parent) {
		return new MazeComposite(parent, SWT.NONE);
	}
	...
	public String getNameKey() {
		return "MazeLayoutPart.gui.name"; //$NON-NLS-1$
	}
