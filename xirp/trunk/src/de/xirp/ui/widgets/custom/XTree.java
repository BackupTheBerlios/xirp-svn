...
public class XTree extends Tree {
	...
	/**
	 * Constructs a new tree. This constructor should be used in
	 ...
	 *            The style.
	 */
	public XTree(Composite parent, int style) {
		super(parent, style);
	 ...
	 */
	public XTree(Composite parent, int style, II18nHandler handler) {
		super(parent, style);
