 ...
 * Changes
 * -------
 * 26.10.2006:		Created by Matthias Gernand.
 */
 ...
 * <br>
 * The button is made abstract, because there are several other
 * widgets which are based on a button, f.e. the
 * {@link de.xirp.ui.widgets.custom.XRadioButton}.
 * 
 * @author Matthias Gernand
 */
abstract class AbstractXButton extends Button {
	 ...
	 *            The style.
	 */
	public AbstractXButton(Composite parent, int style) {
		super(parent, style);
	 ...
	 */
	public AbstractXButton(Composite parent, int style, II18nHandler handler) {
		super(parent, style);
	...
	/**
	 * Initializes the control and sets the appearance and locale
	 * listeners.
	 */
