 ...
 */
public class XCheckBox extends AbstractXButton {

	/**
	 * Constructs a new check box. This constructor should be used in
	 ...
	 */
	public XCheckBox(Composite parent, II18nHandler handler) {
		super(parent, SWT.CHECK, handler);
	}
}
